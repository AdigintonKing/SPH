 ...
 */
    ...
    m_shader_scalar.init("../resources/properties/vs_points_scalar.glsl","../resources/properties/fs_points.glsl");
    m_shader_scalar.use();
    m_shader_scalar.setFloat("radius",sph.h*0.17);
...
if (rendermode==0)
{
...
else
    {
            ...
            glEnableVertexAttribArray(0);
            glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, &translations[0]);
