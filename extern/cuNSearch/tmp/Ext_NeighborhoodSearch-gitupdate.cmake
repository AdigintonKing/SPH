...
execute_process(
  COMMAND "/usr/bin/git" show-ref "aba3da18cb4f45cd05d729465d1725891ffc33da"
  WORKING_DIRECTORY "/home/helton/SPH/SPH_2D_CompactNSearch_GLFW_AVX/extern/cuNSearch/src/Ext_NeighborhoodSearch"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/helton/SPH/SPH_2D_CompactNSearch_GLFW_AVX/extern/cuNSearch/src/Ext_NeighborhoodSearch'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/helton/SPH/SPH_2D_CompactNSearch_GLFW_AVX/extern/cuNSearch/src/Ext_NeighborhoodSearch'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
