...
#define FORALL_FLUID_NEIGHBORS(code) \
 ...
 TColorRGBA redb(1.0,0.0,0.0,0.5);
 ...
 TColorRGBA lyellow(1.0,1.0,0.3,1.0);
 TColorRGBA lyellow2(0.85,0.85,0.2,1.0);
 TColorRGBA yellow(1.0,1.0,0.0,1.0);
 ...
 TColorRGBA skin(205.0 / 255.0, 133.0 / 255.0, 63.0 / 255.0);
 TColorRGBA pink(205.0 / 255.0, 153.0 / 255.0, 200.0 / 255.0);
 #endif
